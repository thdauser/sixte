...
//INPUT PARAMETERS
	...
	int ntaus;				// Number of tauFALLs after starting the pulse to ending it
...
// FUNCTIONS
	...
	int findInterval(gsl_vector *invector, gsl_vector *startpulse, int npin, int n, int nPF, double tau, int interval, int *ni, gsl_vector **startinterval);
