...
// response.
// The spectrum (i.e. the counts) can be normalized in an arbitrary way, 
// as the simulation normalizes the spectrum to 1 after reading it from 
// the file. The source count rate / flux has to be set via the 'src_cps' 
// field in the source catalog.
