...
#define MAX_NORBIT_ENTRIES 500000   // maximum number of entries in the orbit-/attitude-catalog (satellite_catalog)
#define ORBIT_UPDATE_TIME 5400.     // time intervals [s] to update the preselected source catalog
...
int get_satellite_catalog(struct Telescope **, long *nentries, double t0, double timespan, 
			  const char orbit_filename[], const char attitude_filename[]);
