...
/** Red-noise powerlaw (index 1). */
//#define TK_LC_POWERLAW 1 
/** Lorentz profile. */
#define TK_LC_LORENTZ 1

/** Width of the time steps in the light curve generated with the 
    Timmer & Koenig algorithm ([s]). */
#define TK_LC_STEP_WIDTH (0.001) 

/** Length of Timmer&Koenig light curves (number of time bins). */
#define TK_LC_LENGTH (1024*1024)
//(16384)

/** Print the light curve generated by the Timmer & Koenig algorithm
    to an output file. */
#define TK_LC_PRINT_LIGHT_CURVE 1
