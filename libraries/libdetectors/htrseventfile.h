 ...
 * file the function also initializes the HTRSEventFile data structure
 * by calling openHTRSEventFile().  The access_mode parameter is
 * always READWRITE.
 */
 ...
 * increases the internal counter of the HTRSEventFile data structure.
 * In the event file the numbering of the pixels starts at 1, whereas
 * in the returned HTRSEvent data structure the numbering starts at 0.
